    ...
    <?php 
        ...
        if(isset($_POST['submit'])){
            ...
            if ($image_err == 0) { 
                ...
                $insert_query = "insert into products (name, category, description,	bid_amount,	image, start_date_time, end_date_time) values ('$name', '$category', '$description', '$bid_starting_amount', '$dest_image', '$bid_start_date_time', '$bid_end_date_time')";
    ...
    <div class="manage-product">
        <div class="form">
            ...
            <?php } ?>
                ...
                <br>
            <textarea name="p_description" cols="50" rows="5" placeholder="Description"></textarea> <br>
